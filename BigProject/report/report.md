...
* 最高帧频
  ...
  我们计算一个像素平均所需要的MIPS语句大约为10条，可以得出在主频为25MHz的CPU下运行可以达到的最高帧频为$$\frac{25*10^6}{240*160*10}\approx65 $$fps，故可以满足流畅游戏的要求，我们最终设计的帧频为60fps。
...
* 游戏循环
  ...
  ![start](D:\ComputerCompositionExperiment\BigProject\report\start.png)![over](D:\ComputerCompositionExperiment\BigProject\report\over.png)
...
* 画面绘制
  ...
  * 透明处理
    ...
    ![bird](D:\ComputerCompositionExperiment\BigProject\report\bird.png)
