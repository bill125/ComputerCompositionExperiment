...
#Sun Dec 03 16:42:21 GMT+08:00 2017
...
Project.unit<0>.triggerChannel<0><29>=CPUCore_inst/EX_MEM_inst/o_DMRE
Project.unit<0>.triggerChannel<0><2>=UART_inst/o_writeDone
Project.unit<0>.triggerChannel<0><30>=CPUCore_inst/EX_MEM_inst/o_DMWR
Project.unit<0>.triggerChannel<0><31>=CPUCore_inst/ID_EX_inst/o_DMRE
Project.unit<0>.triggerChannel<0><32>=CPUCore_inst/ID_EX_inst/o_DMWR
Project.unit<0>.triggerChannel<0><33>=CPUCore_o_Control_o_DMRE
Project.unit<0>.triggerChannel<0><34>=VGA_inst/VGACore_inst/g1<1>
Project.unit<0>.triggerChannel<0><35>=VGA_inst/VGACore_inst/g1<2>
Project.unit<0>.triggerChannel<0><36>=o_VGA_g_1_OBUF
Project.unit<0>.triggerChannel<0><37>=o_VGA_g_2_OBUF
Project.unit<0>.triggerChannel<0><38>=o_VGA_r_0_OBUF
Project.unit<0>.triggerChannel<0><39>=o_VGA_r_1_OBUF
Project.unit<0>.triggerChannel<0><3>=UART_inst/o_readReady
Project.unit<0>.triggerChannel<0><40>=o_VGA_r_2_OBUF
Project.unit<0>.triggerChannel<0><41>=VGA_inst/VGACore_inst/cnt<17>
Project.unit<0>.triggerChannel<0><42>=VGA_inst/VGACore_inst/cnt<16>
Project.unit<0>.triggerChannel<0><43>=VGA_inst/VGACore_inst/cnt<15>
Project.unit<0>.triggerChannel<0><44>=VGA_inst/VGACore_inst/cnt<14>
Project.unit<0>.triggerChannel<0><45>=VGA_inst/VGACore_inst/cnt<13>
Project.unit<0>.triggerChannel<0><46>=VGA_inst/VGACore_inst/cnt<12>
Project.unit<0>.triggerChannel<0><47>=VGA_inst/VGACore_inst/cnt<11>
Project.unit<0>.triggerChannel<0><48>=VGA_inst/VGACore_inst/cnt<10>
Project.unit<0>.triggerChannel<0><49>=VGA_inst/VGACore_inst/cnt<9>
Project.unit<0>.triggerChannel<0><4>=UART_inst/o_readDone
Project.unit<0>.triggerChannel<0><50>=VGA_inst/VGACore_inst/cnt<8>
Project.unit<0>.triggerChannel<0><51>=VGA_inst/VGACore_inst/cnt<7>
Project.unit<0>.triggerChannel<0><52>=VGA_inst/VGACore_inst/cnt<6>
Project.unit<0>.triggerChannel<0><53>=VGA_inst/VGACore_inst/cnt<5>
Project.unit<0>.triggerChannel<0><54>=VGA_inst/VGACore_inst/cnt<4>
Project.unit<0>.triggerChannel<0><55>=VGA_inst/VGACore_inst/cnt<3>
Project.unit<0>.triggerChannel<0><56>=VGA_inst/VGACore_inst/cnt<2>
Project.unit<0>.triggerChannel<0><57>=VGA_inst/VGACore_inst/cnt<1>
Project.unit<0>.triggerChannel<0><58>=i_UART_data_ready_IBUF
Project.unit<0>.triggerChannel<0><59>=i_UART_tsre_IBUF
Project.unit<0>.triggerChannel<0><5>=UART_inst/o_rdn
Project.unit<0>.triggerChannel<0><60>=i_UART_tbre_IBUF
Project.unit<0>.triggerChannel<0><61>=UART_inst/r_RX_State_FSM_FFd1
Project.unit<0>.triggerChannel<0><62>=UART_inst/r_RX_State_FSM_FFd2
Project.unit<0>.triggerChannel<0><63>=UART_inst/r_TX_State_FSM_FFd1
Project.unit<0>.triggerChannel<0><64>=UART_inst/r_TX_State_FSM_FFd2
Project.unit<0>.triggerChannel<0><65>=UART_inst/r_TX_State_FSM_FFd3
Project.unit<0>.triggerChannel<0><66>=CPUCore_o_IM_o_inst<15>
Project.unit<0>.triggerChannel<0><67>=CPUCore_o_IM_o_inst<14>
Project.unit<0>.triggerChannel<0><68>=CPUCore_o_IM_o_inst<13>
Project.unit<0>.triggerChannel<0><69>=CPUCore_o_IM_o_inst<12>
Project.unit<0>.triggerChannel<0><6>=UART_inst/o_bus_EN
Project.unit<0>.triggerChannel<0><70>=CPUCore_o_IM_o_inst<11>
Project.unit<0>.triggerChannel<0><71>=CPUCore_o_IM_o_inst<10>
Project.unit<0>.triggerChannel<0><72>=CPUCore_o_IM_o_inst<9>
Project.unit<0>.triggerChannel<0><73>=CPUCore_o_IM_o_inst<8>
Project.unit<0>.triggerChannel<0><74>=CPUCore_o_IM_o_inst<7>
Project.unit<0>.triggerChannel<0><75>=CPUCore_o_IM_o_inst<6>
Project.unit<0>.triggerChannel<0><76>=CPUCore_o_IM_o_inst<5>
Project.unit<0>.triggerChannel<0><77>=CPUCore_o_IM_o_inst<4>
Project.unit<0>.triggerChannel<0><78>=CPUCore_o_IM_o_inst<3>
Project.unit<0>.triggerChannel<0><79>=CPUCore_o_IM_o_inst<2>
Project.unit<0>.triggerChannel<0><7>=SystemBusController_UART_readBegin
Project.unit<0>.triggerChannel<0><80>=CPUCore_o_IM_o_inst<1>
Project.unit<0>.triggerChannel<0><81>=CPUCore_o_IM_o_inst<0>
Project.unit<0>.triggerChannel<0><82>=CPUCore_inst/BTB_o_predPC<15>
Project.unit<0>.triggerChannel<0><83>=CPUCore_inst/BTB_o_predPC<14>
Project.unit<0>.triggerChannel<0><84>=CPUCore_inst/BTB_o_predPC<13>
Project.unit<0>.triggerChannel<0><85>=CPUCore_inst/BTB_o_predPC<12>
Project.unit<0>.triggerChannel<0><86>=CPUCore_inst/BTB_o_predPC<11>
Project.unit<0>.triggerChannel<0><87>=CPUCore_inst/BTB_o_predPC<10>
Project.unit<0>.triggerChannel<0><88>=CPUCore_inst/BTB_o_predPC<9>
Project.unit<0>.triggerChannel<0><89>=CPUCore_inst/BTB_o_predPC<8>
Project.unit<0>.triggerChannel<0><8>=SystemBusController_UART_writeBegin
Project.unit<0>.triggerChannel<0><90>=CPUCore_inst/BTB_o_predPC<7>
Project.unit<0>.triggerChannel<0><91>=CPUCore_inst/BTB_o_predPC<6>
Project.unit<0>.triggerChannel<0><92>=CPUCore_inst/BTB_o_predPC<5>
Project.unit<0>.triggerChannel<0><93>=CPUCore_inst/BTB_o_predPC<4>
Project.unit<0>.triggerChannel<0><94>=CPUCore_inst/BTB_o_predPC<3>
Project.unit<0>.triggerChannel<0><95>=CPUCore_inst/BTB_o_predPC<2>
Project.unit<0>.triggerChannel<0><96>=CPUCore_inst/BTB_o_predPC<1>
Project.unit<0>.triggerChannel<0><97>=CPUCore_inst/BTB_o_predPC<0>
